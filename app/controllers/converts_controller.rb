...
class ConvertsController < ApplicationController
 skip_before_action :verify_authenticity_token  
  ...
  %x("#{Rails.root}/public/office/program/soffice" --invisible --nologo -convert-to pdf:writer_pdf_Export --outdir  "#{Rails.root}/public/file_conversion/" "#{Rails.root}/public/#{params[:file_convertor][:filename]}.xlsx")
